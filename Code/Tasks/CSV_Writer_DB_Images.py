...
pickle.dump(final_annot_tf , open("C:\\MWDB Project\\Code\\CSV\\Task_2\\save_tf.p", "wb" ) )
pickle.dump(final_annot_df , open("C:\\MWDB Project\\Code\\CSV\\Task_2\\save_df.p", "wb" ) )
pickle.dump(final_annot_idf , open("C:\\MWDB Project\\Code\\CSV\\Task_2\\save_idf.p", "wb" ) )

# Writing the schema into csv files for future access
with open("C:\\MWDB Project\\Code\\CSV\\Task_2\\TF_Img.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
...
with open("C:\\MWDB Project\\Code\\CSV\\Task_2\\DF_Img.csv", 'w', encoding = 'utf8', newline='') as outcsv: 
    #configure writer to write standard csv file
    writer = csv.writer(outcsv, delimiter=',', quotechar = "'")
...
with open("C:\\MWDB Project\\Code\\CSV\\Task_2\\IDF_Img.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
    #configure writer to write standard csv file
    writer = csv.writer(outcsv, delimiter=',', quotechar = "'")
