...
#pickle.load(final_annot_tf , open("C:\\MWDB Project\\Code\\CSV\\Task_2\\save_tf.p", "rb" ))
#pickle.load(final_annot_df , open("C:\\MWDB Project\\Code\\CSV\\Task_2\\save_df.p", "rb" ) )
#pickle.load(final_annot_idf , open("C:\\MWDB Project\\Code\\CSV\\Task_2\\save_idf.p", "rb" ) )

# Reading the sample input file

file1 = open("C:\\MWDB Project\\Code\\Sample_Inputs_Img.txt","r", encoding="utf8")
...
for line in list_of_lines:
    ...
    df = pd.read_csv("C:\\MWDB Project\\Code\\CSV\\Task_2\\{}_Img.csv".format(input_type))
