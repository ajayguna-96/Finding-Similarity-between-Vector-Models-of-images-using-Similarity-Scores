...
with open("C:\\MWDB Project\\Code\\CSV\\Task_1\\TF_User.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
...
with open("C:\\MWDB Project\\Code\\CSV\\Task_1\\DF_User.csv", 'w', encoding = 'utf8', newline='') as outcsv: 
    #configure writer to write standard csv file
    writer = csv.writer(outcsv, delimiter=',', quotechar = "'")
...
with open("C:\\MWDB Project\\Code\\CSV\\Task_1\\TF_IDF_User.csv", 'w', encoding = 'utf8', newline='') as outcsv:   
    #configure writer to write standard csv file
    writer = csv.writer(outcsv, delimiter=',', quotechar = "'")
