...
file1 = open("C:\\MWDB Project\\Code\\Sample_Inputs_CMS.txt","r", encoding="utf8")
...
for line in list_of_lines:
    ...
    for model in models:
        list_of_lines = list()
        csvfile = open("C:\\MWDB Project\\Code\\CSV\\img_edit_task5\\{}Edit.csv".format(loc + " " + model),"r", encoding="utf8")
        ...
        for number in file_numbers:
            list_of_lines = list()
            csvfile = open("C:\\MWDB Project\\Code\\CSV\\img_edit_task5\\{}Edit.csv".format(location_id[number] + " " + model),"r", encoding="utf8")
            reader = csv.reader(csvfile, delimiter=',', quotechar = "'")
            list_of_lines = list(reader)
            loader_list = list(map(list, zip(*list_of_lines)))
